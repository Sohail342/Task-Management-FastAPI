...
def create_access_token(data: Dict[str, Any], expires_delta: Optional[timedelta] = None) -> str:
    ...
    if expires_delta:
        ...
        expire = datetime.now(timezone.utc) + timedelta(seconds=settings.AUTHJWT_ACCESS_TOKEN_EXPIRES)
...
def create_refresh_token(data: Dict[str, Any], expires_delta: Optional[timedelta] = None) -> str:
    ...
    if expires_delta:
        ...
        expire = datetime.now(timezone.utc) + timedelta(seconds=settings.AUTHJWT_REFRESH_TOKEN_EXPIRES)
